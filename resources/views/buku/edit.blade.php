...
@endif
       ...
       <form action='{{ url('buku/update/'.$data->id) }}' method='post'>
        @csrf
        @method('PUT')
        <div class="card">
            ...
            <div class="card-body">
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name='stock' value="{{$data->stock}}" id="stock">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jurusan" class="col-sm-2 col-form-label">Tanggal Terbit</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name='tanggal_terbit' value="{{$data->tanggal_terbit}}" id="tanggal_terbit">
                        </div>
                    </div>
                    <div class="mb-3 row">
