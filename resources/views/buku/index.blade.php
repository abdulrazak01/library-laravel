...
<html lang="en">
  ...
  <body class="bg-light">
    <main class="container">
        ...
        <!-- START DATA -->
        <div class="card">
          <h5 class="card-header">List Data Buku</h5>
          <div class="card-body">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <form onsubmit="return confirm('Apakah Anda Yakin Ingin Mengahpus Data ini?')"class="d-inline" action="{{url('buku/delete/'.$item->id)}}" method="post">
                               @csrf
                               @method('DELETE')
